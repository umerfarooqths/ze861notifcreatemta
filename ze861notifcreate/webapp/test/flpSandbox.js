						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#AddNotification-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"AddNotification-display": {
								"semanticObject": "AddNotification",
								"action": "display",
								"description": "Add Notification (Corrective)",
								"title": "Add Notification",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpm.e861.wo.ze861notifcreate",
									"url": sap.ui.require.toUrl("zpm/e861/wo/ze861notifcreate")
								}
							}
						}
					}
